...
namespace Quanlikhachsan {
    ...
    public partial class QLKSDataSet1 : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK__customer__roomid__145C0A3F;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK__customer__roomid__145C0A3F = this.Relations["FK__customer__roomid__145C0A3F"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK__customer__roomid__145C0A3F = new global::System.Data.DataRelation("FK__customer__roomid__145C0A3F", new global::System.Data.DataColumn[] {
                        this.tablerooms.roomidColumn}, new global::System.Data.DataColumn[] {
                        this.tablecustomer.roomidColumn}, false);
            this.Relations.Add(this.relationFK__customer__roomid__145C0A3F);
        }
        ...
        public partial class customerDataTable : global::System.Data.TypedTableBase<customerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public customerRow AddcustomerRow(string cname, long mobile, string nationality, string gender, string dob, string idproof, string address, string checkin, string checkout, string chekout, roomsRow parentroomsRowByFK__customer__roomid__145C0A3F) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        chekout,
                        null};
                if ((parentroomsRowByFK__customer__roomid__145C0A3F != null)) {
                    columnValuesArray[11] = parentroomsRowByFK__customer__roomid__145C0A3F[0];
                }
        ...
        public partial class customerRow : global::System.Data.DataRow {
            ...
            public roomsRow roomsRow {
                get {
                    return ((roomsRow)(this.GetParentRow(this.Table.ParentRelations["FK__customer__roomid__145C0A3F"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK__customer__roomid__145C0A3F"]);
                }
            }
        ...
        public partial class roomsRow : global::System.Data.DataRow {
            ...
            public customerRow[] GetcustomerRows() {
                if ((this.Table.ChildRelations["FK__customer__roomid__145C0A3F"] == null)) {
                    return new customerRow[0];
                }
                else {
                    return ((customerRow[])(base.GetChildRows(this.Table.ChildRelations["FK__customer__roomid__145C0A3F"])));
                }
            }
        }
...
namespace Quanlikhachsan.QLKSDataSet1TableAdapters {
    ...
    public partial class customerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[customer] ([cname], [mobile], [nationality], [gender], [dob], [idproof], [address], [checkin], [checkout], [chekout], [roomid]) VALUES (@cname, @mobile, @nationality, @gender, @dob, @idproof, @address, @checkin, @checkout, @chekout, @roomid);
SELECT cid, cname, mobile, nationality, gender, dob, idproof, address, checkin, checkout, chekout, roomid FROM customer WHERE (cid = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[customer] SET [cname] = @cname, [mobile] = @mobile, [nationality] = @nationality, [gender] = @gender, [dob] = @dob, [idproof] = @idproof, [address] = @address, [checkin] = @checkin, [checkout] = @checkout, [chekout] = @chekout, [roomid] = @roomid WHERE (([cid] = @Original_cid) AND ([cname] = @Original_cname) AND ([mobile] = @Original_mobile) AND ([nationality] = @Original_nationality) AND ([gender] = @Original_gender) AND ([dob] = @Original_dob) AND ([idproof] = @Original_idproof) AND ([address] = @Original_address) AND ([checkin] = @Original_checkin) AND ((@IsNull_checkout = 1 AND [checkout] IS NULL) OR ([checkout] = @Original_checkout)) AND ((@IsNull_chekout = 1 AND [chekout] IS NULL) OR ([chekout] = @Original_chekout)) AND ([roomid] = @Original_roomid));
SELECT cid, cname, mobile, nationality, gender, dob, idproof, address, checkin, checkout, chekout, roomid FROM customer WHERE (cid = @cid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Quanlikhachsan.Properties.Settings.Default.QLKSConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT cid, cname, mobile, nationality, gender, dob, idproof, address, checkin, c" +
                "heckout, chekout, roomid FROM dbo.customer";
        ...
        public virtual int Fill(QLKSDataSet1.customerDataTable dataTable) {
        ...
        public virtual QLKSDataSet1.customerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLKSDataSet1.customerDataTable dataTable = new QLKSDataSet1.customerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLKSDataSet1.customerDataTable dataTable) {
        ...
        public virtual int Delete(int Original_cid, string Original_cname, long Original_mobile, string Original_nationality, string Original_gender, string Original_dob, string Original_idproof, string Original_address, string Original_checkin, string Original_checkout, string Original_chekout, int Original_roomid) {
            ...
            if ((Original_chekout == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[12].Value = ((string)(Original_chekout));
            }
        ...
        public virtual int Insert(string cname, long mobile, string nationality, string gender, string dob, string idproof, string address, string checkin, string checkout, string chekout, int roomid) {
            if ((cname == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_chekout == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[23].Value = ((string)(Original_chekout));
            }
            this.Adapter.UpdateCommand.Parameters[24].Value = ((int)(Original_roomid));
            this.Adapter.UpdateCommand.Parameters[25].Value = ((int)(cid));
        ...
        public virtual int Update(
                    ...
                    string Original_chekout, 
                    int Original_roomid) {
            return this.Update(cname, mobile, nationality, gender, dob, idproof, address, checkin, checkout, chekout, roomid, Original_cid, Original_cname, Original_mobile, Original_nationality, Original_gender, Original_dob, Original_idproof, Original_address, Original_checkin, Original_checkout, Original_chekout, Original_roomid, Original_cid);
        }
    }
...
SELECT roomid, roomNo, roomType, bed, price, booked FROM rooms WHERE (roomid = @roomid)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(QLKSDataSet1.roomsDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual QLKSDataSet1.roomsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLKSDataSet1.roomsDataTable dataTable = new QLKSDataSet1.roomsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLKSDataSet1.roomsDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
